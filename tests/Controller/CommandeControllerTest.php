...
class CommandeControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'commande[id_paiement]' => 'Testing',
            'commande[id_acheteur]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setId_paiement('My Title');
        $fixture->setId_acheteur('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'commande[id_paiement]' => 'Something New',
            'commande[id_acheteur]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getId_paiement());
        self::assertSame('Something New', $fixture[0]->getId_acheteur());
    }
