...
class ProduitControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'produit[id_user]' => 'Testing',
            'produit[id_commande]' => 'Testing',
            'produit[id_categorie]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'produit[id_user]' => 'Something New',
            'produit[id_commande]' => 'Something New',
            'produit[id_categorie]' => 'Something New',
        ]);
